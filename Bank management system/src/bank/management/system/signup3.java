...
public class signup3 extends JFrame implements ActionListener{
     ...
     public signup3(String formno)
    {
        ...
        add(l1); // right now it will not be visible as you have to set bounds of it
        
         JLabel type = new JLabel("Account Type");
        type.setFont(new Font("Raleway" ,  Font.BOLD , 22));
        type.setBounds(100 ,85 , 200 , 30);
        add(type); // right now it will not be visible as you have to set bounds of it
        
        
        
         setSize(850,820);// setting frame size
        setVisible(true); // setting frame visible to us ( bydefault : notvisible)
        setLocation(350, 0); // setting location of frame 
        ...
        add(card); // right now it will not be visible as you have to set bounds of it
        
        JLabel number = new JLabel("XXXX-XXXX-XXXX-4184");
        number.setFont(new Font("Raleway" ,  Font.BOLD , 22));
        number.setBounds(330 ,200 , 300 , 30);
        add(number); // right now it will not be visible as you have to set bounds of it
        ...
        add(pnumber); // right now it will not be visible as you have to set bounds of it
        ...
        c7=new JCheckBox("Hereby declares that above details are correct to the best of my knowledge");
