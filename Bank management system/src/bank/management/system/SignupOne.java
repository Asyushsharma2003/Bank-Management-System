...
import java.util.*;
import com.toedter.calendar.JDateChooser;   // for importing calender in DOB
...
public class SignupOne extends JFrame implements ActionListener {
    ...
    public SignupOne()
        ...
        add(formno); // right now it will not be visible as you have to set bounds of it
        
            
        JLabel persondetails = new JLabel("Page 1: Personal Details");
        persondetails.setFont(new Font("Raleway" ,  Font.BOLD , 22));
        persondetails.setBounds(290 ,80 , 400 , 30);
        add(persondetails); // right now it will not be visible as you have to set bounds of it
        ...
        datechooser = new JDateChooser();   // for calender
        ...
        // creating radio button for selecting gender
       ...
       martialstatus.add(other);
        ...
        add(city); // right now it will not be visible as you have to set bounds of it
        ...
        add(pincode); // right now it will not be visible as you have to set bounds of it
